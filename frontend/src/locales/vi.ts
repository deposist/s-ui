export default {
  ...
  pages: {
    ...
    migrateXuiSchedule: "Đồng bộ 3x-ui",
    settings: "Cài đặt",
  },
  telegram: {
    title: "Telegram",
  ...
  migrateXui: {
    ...
    schedule: {
      open: "Mở lịch đồng bộ",
      title: "Lịch đồng bộ 3x-ui",
      remoteDisabled: "Nguồn 3x-ui từ xa đang bị tắt",
      profileName: "Tên hồ sơ",
      sourceType: "Loại nguồn",
      username: "Tên đăng nhập",
      password: "Mật khẩu",
      keyPath: "Đường dẫn khóa SSH",
      remotePath: "Đường dẫn cơ sở dữ liệu từ xa",
      acceptHostKey: "Chấp nhận host key",
      hostFingerprint: "Dấu vân tay host",
      sshUrl: "SSH URL",
      httpUrl: "3x-ui HTTP URL",
      cron: "Lịch",
      onlyNew: "Chỉ đối tượng mới",

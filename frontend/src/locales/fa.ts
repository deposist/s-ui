export default {
  ...
  pages: {
    ...
    migrateXuiSchedule: "همگام‌سازی 3x-ui",
    settings: "پیکربندی",
  },
  telegram: {
    title: "Telegram",
  ...
  migrateXui: {
    ...
    schedule: {
      open: "باز کردن زمان‌بندی همگام‌سازی",
      title: "زمان‌بندی همگام‌سازی 3x-ui",
      remoteDisabled: "منابع راه‌دور 3x-ui غیرفعال هستند",
      profileName: "نام پروفایل",
      sourceType: "نوع منبع",
      username: "نام کاربری",
      password: "گذرواژه",
      keyPath: "مسیر کلید SSH",
      remotePath: "مسیر پایگاه داده راه‌دور",
      acceptHostKey: "پذیرش کلید میزبان",
      hostFingerprint: "اثر انگشت میزبان",
      sshUrl: "نشانی SSH",
      httpUrl: "نشانی HTTP 3x-ui",
      cron: "زمان‌بندی",
      onlyNew: "فقط اشیای جدید",
      lastRun: "آخرین اجرا",
      status: "وضعیت",
